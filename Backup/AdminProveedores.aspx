<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AdminProveedores.aspx.cs" Inherits="Arrendamientos.AdminProveedores" %>
        ...
        <div class="card-body">
            <table width="100%" class="table">
                <tr>
                    ...
                    <td>
                        <asp:Button runat="server" ID="BtnAgregar" CssClass="btn btn-info" Text="Agregar proveedor" onclick="btnAgregar_Click" />
                    </td>
                </tr>
            </table>
        </div>
        <asp:Panel ID="panela" Width="100%" Height="400px" ScrollBars="Horizontal" runat="server">
                <asp:GridView ID="Grida" CssClass="table table-bordered" OnRowCommand="Comandos" AutoGenerateColumns="False" DataKeyNames="Id" runat="server" CellPadding="4" GridLines="None" Width="97%">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="Proveedor" DataField="Valor" />
