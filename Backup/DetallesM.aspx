        ...
        <div class="card-body">
            <table width="100%" class="table">
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox runat="server" ID="txtMoneda" CssClass="form-control" placeholder="Presiona * para ver toda la lista de Monedas"></asp:TextBox>
                        <ajaxToolkit:AutoCompleteExtender ID="AutoCompleteExtender5" runat="server" ServiceMethod="CompletarMoneda" MinimumPrefixLength="1" CompletionInterval="10" EnableCaching="false" CompletionSetCount="1" TargetControlID="txtMoneda" FirstRowSelected="false">
                        </ajaxToolkit:AutoCompleteExtender>
                    </td>
                </tr>
                <tr>
