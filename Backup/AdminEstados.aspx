<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AdminEstados.aspx.cs" Inherits="Arrendamientos.AdminEstados" %>
        ...
        <div class="card-body">
            <table width="100%" class="table">
                <tr>
                    ...
                    <td>
                        <asp:Button runat="server" ID="BtnAgregar" CssClass="btn btn-info" Text="Agregar estado" onclick="btnAgregar_Click" />
                    </td>
                </tr>
            </table>
        </div>
        <asp:Panel ID="panela" Width="100%" Height="400px" ScrollBars="Horizontal" runat="server">
                <asp:GridView ID="Grida" CssClass="table table-bordered" OnRowCommand="Comandos" AutoGenerateColumns="False" DataKeyNames="Id" runat="server" CellPadding="4" GridLines="None" Width="97%">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="Estado" DataField="Valor" />
