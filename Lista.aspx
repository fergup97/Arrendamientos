    ...
    <div class="card">
        ...
        <table width="100%" class="table">
            ...
            <asp:Panel ID="panela" Width="100%" Height="400px" ScrollBars="Horizontal" runat="server">
                <asp:GridView ID="Grida" CssClass="table table-bordered" OnRowCommand="Comandos" AutoGenerateColumns="False" DataKeyNames="Id,Usuario,Estatus" runat="server" CellPadding="4" GridLines="None" Width="97%">
